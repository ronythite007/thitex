    ...
    <section className="relative w-full py-32 md:py-48 bg-background flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-10 relative z-10 text-center">
        ...
        >
          ...
          <span className="font-mono-tech text-primary text-xs font-bold tracking-[0.2em] uppercase">The THITEX Story</span>
        </motion.div>
        ...
        >
          Engineering <span className="text-primary italic font-light">brilliance.</span>
        </motion.h1>
        ...
        >
          We are a privately held collective of elite engineers, designers, and strategists. We build the architecture that powers tomorrow's industry leaders.
        </motion.p>
      </div>
    </section>
  );
